...
public final class lista_005fusuarios_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  private boolean _jspx_meth_u_forEach_0(PageContext _jspx_page_context)
    ...
    _jspx_th_u_forEach_0.setItems(new String("$(lista_usuarios)"));
    _jspx_th_u_forEach_0.setVar("usuario");
    ...
    try {
      ...
      if (_jspx_eval_u_forEach_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
        do {
          out.write("\n");
          out.write("                <tr>\n");
          out.write("                    <td>$(usuario.user)</td>\n");
          out.write("                    <td>$(usuario.pass)</td>\n");
          out.write("                </tr>\n");
          out.write("            ");
